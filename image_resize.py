...
if __name__ == '__main__':
    ...
    parser.add_argument('--width',
                        ...
                        help='Image resize width.'
                             'You cant use --scale with this option')
    ...
    parser.add_argument('--scale',
                        ...
                        help='Zoom ratio.'
                             ...
                             ' you cant use --width and --height')
    parser.add_argument('--output',
                        help='Resized file destination. '
                             'If this option not used, '
                             'the file saved near the original file')
    args = parser.parse_args()
    if args.scale and args.height or args.width:
        parser.error("You can`t use --scale option "
